...
if okHui and hui then parentGui = hui else parentGui = LP:WaitForChild("PlayerGui") end
...
local T = {
    RU = {
        tab_combat = "Бой", tab_visual = "Визуал", tab_move = "Движение",
        tab_tp = "Телепорт", tab_settings = "Настройки",
        sec_aim = "ПРИЦЕЛ", sec_hitbox = "ХИТБОКС",
        sec_esp = "ESP ИГРОКОВ", sec_chams = "ПОДСВЕТКА", sec_vesp = "ТЕХНИКА",
        sec_veh = "ТЕХНИКА", sec_player = "ИГРОК",
        sec_tp_player = "К ИГРОКУ", sec_tp_objects = "К ОБЪЕКТАМ", sec_tp_marks = "МЕТКИ",
        sec_colors = "ЦВЕТА ТЕМЫ", sec_size = "РАЗМЕР МЕНЮ", sec_lang = "ЯЗЫК",
        sec_config = "КОНФИГ", sec_world = "МИР", sec_help = "СПРАВКА",
        aim = "Аимбот (по нажатию)", team = "Проверка команды", wall = "Проверка стен",
        fov = "Радиус захвата", smooth = "Плавность",
        hitbox = "Увеличение хитбокса", hitbox_size = "Размер хитбокса",
        esp = "ESP игроков", box = "Квадрат", name = "Никнейм", hp = "Здоровье",
        dist = "Дистанция", esp_team = "Проверка команды (ESP)",
        chams = "Подсветка сквозь стены", world = "ESP техники",
        veh_fly = "Полёт техники",
        fly = "Полёт", fly_speed = "Скорость полёта", noclip = "Сквозь стены",
        walk = "Своя скорость", walk_speed = "Скорость ходьбы",
        jump = "Свой прыжок", jump_power = "Сила прыжка",
        select_player = "Выберите игрока", no_players = "Нет других игроков",
        tp_player = "Телепорт к игроку", tp_airdrop = "К ближайшему аирдропу",
        tp_oil = "К ближайшей нефти", tp_capture = "К точке захвата",
        tp_veh = "К ближайшей технике", save_pos = "Сохранить позицию", load_pos = "Вернуться",
        red = "Красный", blue = "Синий", purple = "Фиолет", green = "Зелёный",
        cyan = "Голубой", orange = "Оранж", yellow = "Жёлтый", pink = "Розовый",
        scale = "Масштаб", apply = "Применить",
        save_cfg = "Сохранить под именем", load_cfg = "Загрузить по имени",
        list_cfgs = "Список конфигов", reset_move = "Сбросить движение",
        cfg_name = "Имя конфига",
        fullbright = "Полная яркость",
        lang_ru = "🇷🇺 Русский", lang_en = "🇬🇧 English",
        on = "ВКЛ", off = "ВЫКЛ", bind_ph = "—",
        bind_sub = "Escape — отмена", bind_for = "Бинд: ",
        help = "/aim /esp /fly /noclip\n/chams /world /fb /menu\n/hitbox /reset /save /load",
    },
    EN = {
        tab_combat = "Combat", tab_visual = "Visuals", tab_move = "Movement",
        tab_tp = "Teleport", tab_settings = "Settings",
        sec_aim = "AIM", sec_hitbox = "HITBOX",
        sec_esp = "PLAYER ESP", sec_chams = "CHAMS", sec_vesp = "VEHICLES",
        sec_veh = "VEHICLE", sec_player = "PLAYER",
        sec_tp_player = "TO PLAYER", sec_tp_objects = "TO OBJECTS", sec_tp_marks = "WAYPOINTS",
        sec_colors = "THEME COLORS", sec_size = "MENU SIZE", sec_lang = "LANGUAGE",
        sec_config = "CONFIG", sec_world = "WORLD", sec_help = "HELP",
        aim = "Aimbot (toggle)", team = "Team Check", wall = "Wall Check",
        fov = "FOV", smooth = "Smoothness",
        hitbox = "Hitbox Extender", hitbox_size = "Hitbox Size",
        esp = "Player ESP", box = "Box", name = "Name", hp = "Health",
        dist = "Distance", esp_team = "Team Check (ESP)",
        chams = "Chams", world = "Vehicle ESP",
        veh_fly = "Vehicle Fly",
        fly = "Fly", fly_speed = "Fly Speed", noclip = "Noclip",
        walk = "Custom WalkSpeed", walk_speed = "WalkSpeed",
        jump = "Custom JumpPower", jump_power = "JumpPower",
        select_player = "Select player", no_players = "No other players",
        tp_player = "Teleport to player", tp_airdrop = "To nearest Airdrop",
        tp_oil = "To nearest Oil Rig", tp_capture = "To Capture Point",
        tp_veh = "To nearest Vehicle", save_pos = "Save position", load_pos = "Return",
        red = "Red", blue = "Blue", purple = "Purple", green = "Green",
        cyan = "Cyan", orange = "Orange", yellow = "Yellow", pink = "Pink",
        scale = "Scale", apply = "Apply",
        save_cfg = "Save as", load_cfg = "Load by name",
        list_cfgs = "List configs", reset_move = "Reset movement",
        cfg_name = "Config name",
        fullbright = "Fullbright",
        lang_ru = "🇷🇺 Русский", lang_en = "🇬🇧 English",
        on = "ON", off = "OFF", bind_ph = "—",
        bind_sub = "Escape — cancel", bind_for = "Bind: ",
        help = "/aim /esp /fly /noclip\n/chams /world /fb /menu\n/hitbox /reset /save /load",
    }
}
...
local Config = {
    ...
    Scale = 1,
    Aim = false, FOV = 150, Smooth = 0.2,
    TeamCheck = true, WallCheck = false,
    Hitbox = false, HitboxSize = 3,
    ESP = false, ESPBox = true, ESPName = true, ESPHealth = true, ESPDist = true,
    ESPTeam = false, Chams = false,
    WorldESP = false, VehicleFly = false,
    Fly = false, FlySpeed = 60, Noclip = false,
    WalkSpeed = false, WalkSpeedVal = 32,
    JumpPower = false, JumpPowerVal = 65,
    Fullbright = false, Lang = "EN",
}
Config.Accent = Color3.fromRGB(Config.AccentR, Config.AccentG, Config.AccentB)

local Binds = {
    Aim = nil, ESP = nil, Chams = nil, WorldESP = nil,
    Fly = nil, Noclip = nil, WalkSpeed = nil, JumpPower = nil,
    Hitbox = nil, Fullbright = nil, VehicleFly = nil,
}
    ...
    pcall(function()
        ...
        if data.config then
            for k, v in pairs(data.config) do
                if Config[k] ~= nil and (type(v) == "boolean" or type(v) == "number" or type(v) == "string") then
                    Config[k] = v
                end
            end
        end
...
local function applyAccent(c)
    ...
    for _, t in ipairs(acc.tabs) do
        if t.active then t.btn.TextColor3 = c end
    end
...
local function openBindPicker(bindKey, labelTxt, updateLabel)
    ...
    bst.Color = Config.Accent; bst.Thickness = 1.5
...
-- ФИКС: local ref объявлен отдельно, потом присваивается
local toggleRefs = {}
...
local function slider(p, t, mn, mx, d, cb, labelKey)
    ...
    bg.InputEnded:Connect(function(i) if i.UserInputType == Enum.UserInputType.MouseButton1 then drag = false; saveConfig() end end)
...
slider(CombatTab, T[Lang].smooth, 0, 1, 0.2, function(v) Config.Smooth = v end, "smooth")
...
local function isVeh(m)
    ...
    local pn = par.Name
    if pn == "Helicopter Workspace" or pn == "Vehicle Workspace"
        or pn == "Plane Workspace" or pn == "Tank Workspace"
        or pn == "Submarine Workspace" then return true end
    return false
end
...
local function updatePlayer()
    if Config.Fly and Root and Root.Parent then
        if not pFlyV or pFlyV.Parent ~= Root then
            if pFlyV then pFlyV:Destroy() end
            if pFlyG then pFlyG:Destroy() end
            pFlyV = Instance.new("BodyVelocity")
            pFlyV.MaxForce = Vector3.new(1e5, 1e5, 1e5); pFlyV.Velocity = Vector3.zero
            pFlyV.Parent = Root
            pFlyG = Instance.new("BodyGyro")
            pFlyG.MaxTorque = Vector3.new(1e5, 1e5, 1e5); pFlyG.P = 1000; pFlyG.D = 50
            pFlyG.Parent = Root
        end
        ...
        pFlyV.Velocity = dir; pFlyG.CFrame = Camera.CFrame
    else
        if pFlyV then pFlyV:Destroy(); pFlyV = nil end
        if pFlyG then pFlyG:Destroy(); pFlyG = nil end
    end
    if Humanoid then
...
local function updateVehicle()
    ...
    if not veh then
        if vFlyV then vFlyV:Destroy(); vFlyV = nil end
        if vFlyG then vFlyG:Destroy(); vFlyG = nil end
        return
    end
    local base = veh.PrimaryPart or seat
    if Config.VehicleFly then
        if not vFlyV or vFlyV.Parent ~= base then
            if vFlyV then vFlyV:Destroy() end
            if vFlyG then vFlyG:Destroy() end
            vFlyV = Instance.new("BodyVelocity")
            vFlyV.MaxForce = Vector3.new(1e5, 1e5, 1e5); vFlyV.Velocity = Vector3.zero
            vFlyV.Parent = base
            vFlyG = Instance.new("BodyGyro")
            vFlyG.MaxTorque = Vector3.new(1e5, 1e5, 1e5); vFlyG.P = 2000; vFlyG.D = 100
            vFlyG.Parent = base
        end
        local dir = Vector3.zero
        if UIS:IsKeyDown(Enum.KeyCode.W) then dir = dir + Camera.CFrame.LookVector end
        ...
        if UIS:IsKeyDown(Enum.KeyCode.D) then dir = dir + Camera.CFrame.RightVector end
        if UIS:IsKeyDown(Enum.KeyCode.Space) then dir = dir + Vector3.new(0, 1, 0) end
        if dir.Magnitude > 0 then dir = dir.Unit * 100 end
        vFlyV.Velocity = dir; vFlyG.CFrame = Camera.CFrame
    else
        if vFlyV then vFlyV:Destroy(); vFlyV = nil end
        if vFlyG then vFlyG:Destroy(); vFlyG = nil end
    end
...
local function chatCmd(msg)
    ...
    elseif msg == "/load" then
        loadConfigAs("default"); applyLang()
...
UIS.InputBegan:Connect(function(input, gpe)
    ...
    elseif input.UserInputType == Enum.UserInputType.MouseWheel then
        k = (input.Position.Z > 0) and "WheelUp" or "WheelDown"
    else return end
...
RunService.RenderStepped:Connect(function(dt)
    ...
    tESP = tESP + dt
    if tESP >= 0.03 then tESP = 0; updateESP() end
...
print("[WAR TYCOON HUB v13] Loaded. Bind: J.")
